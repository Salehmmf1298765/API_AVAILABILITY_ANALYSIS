...
### متوفر في Odoo (بدون تخصيص أعمال)
...
### غير متوفر (يتطلب تخصيص أعمال جديد بالإضافة إلى طبقة الـ API)
...
- قاعدة شائعة للتكامل الأول مع Odoo (بما في ذلك منحنى التعلم) هي **20 ساعة**، والتكاملات المشابهة لاحقًا تصبح أسرع بعد تثبيت الأنماط.
